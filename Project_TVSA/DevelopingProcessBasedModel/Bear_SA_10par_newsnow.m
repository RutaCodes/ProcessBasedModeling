...
save bear_lake_hymod_5000hyd_ofs_best_snow_Nrun1.mat SFDCE_high_yr SFDCE_mid_yr SFDCE_low_yr SFDCEP_high_yr SFDCEP_mid_yr SFDCEP_low_yr %SFDCE_high_whole SFDCE_mid_whole SFDCE_low_whole %EP_obs EP_obs_yr EP_sim_yr EP_sim
save bear_lake_hymod_5000hyd_ofs_loop_snow_Newrun1.mat SFDCE SFDCEP %SFDCE.high_yr_loop SFDCE.mid_yr_loop SFDCE.low_yr_loop SFDCEP.high_yr_loop SFDCEP.mid_yr_loop SFDCEP.low_yr_loop
...
save bear_lake_SA_5000ofs_yr_snow_Newrun1.mat NSE_whole KGE_whole NSEyear WByear KGEyear RREyear %Myear %N by year nr
save bear_lake_SA_5000sim_snow_Newrun1.mat PE_value %data length by 1
save bear_lake_SA_5000pars_snow_Newrun1.mat XALL %N by par  nr
...
%save bear_lake_sens_yr_hyd_run5000_snow_Newrun1.mat SFDCEP_high_yearSi SFDCEP_high_yearSTi SFDCEP_mid_yearSi SFDCEP_mid_yearSTi SFDCEP_low_yearSi SFDCEP_low_yearSTi
save bear_lake_sens_yr_run5000_snow_Newrun1.mat WByearSi WByearSTi NSEyearSi NSEyearSTi KGEyearSi KGEyearSTi RREyearSi RREyearSTi %MyearSi MyearSTi %year nr by par nr
...
%save bear_lake_sens_yr_hyd_mo_run5000_snow_Newrun1.mat SFDCEP_high_mo_yearSi SFDCEP_high_mo_yearSTi SFDCEP_mid_mo_yearSi SFDCEP_mid_mo_yearSTi SFDCEP_low_mo_yearSi SFDCEP_low_mo_yearSTi
...
save bear_lake_sens_mo_run5000_snow_Newrun1.mat WBmoSi WBmoSTi NSEmoSi NSEmoSTi KGEmoSi KGEmoSTi RREmoSi RREmoSTi %MyearSi MyearSTi %year nr by par nr
